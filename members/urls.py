...
from .views import UpdateCustomerView, UserRegisterFinishView, pic_update, UserList, authentication, progress_save, logout, register, user_customer, UserProgressDetail, UserProfile, UserUpdate
